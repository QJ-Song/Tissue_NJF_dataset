...
| Cross-group basis comparison | action-family design and solver | contact point, material, and targeted boundary changes | Is one basis shared across conditions? | Not fully; response basis is condition-dependent. |
